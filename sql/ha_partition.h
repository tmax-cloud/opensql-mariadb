...
public:
  ...
  */
  ...
  int create_partitioning_metadata(const char *name, const char *old_name,
                                   chf_create_flags action_flag) override;
...
public:
  ...
  */
  ...
  virtual const char *real_table_type() const override { return table_type(); }
