                        ...
                        double *read_cost, ha_rows *records)
{
  ...
  /*
    ...
    as the sum of:
    1. Cost for evaluating the condition for each num_group (1/TIME_FOR_COMPARE)
       (similarly as for index scan).
    2. Cost for navigating the index structure (assuming a b-tree).
       Note: We only add the cost for one index comparision per block. For a
             ...
             is low as all of the upper level b-tree blocks should be in memory.
